...
public class UserSettingsDTO{
	...
	public UserSettingsDTO(Long id, Visibility userInfoPrivacy,Visibility postPrivacy,Visibility goalPrivacy,Boolean newComments,Boolean newLikes,Boolean friendshipRequest,Boolean acceptedFriendship,Boolean activityRequest,Boolean acceptedActivity,Boolean canceledActivity,Boolean nightTheme){
		this.id = id;
	...
	public UserSettingsDTO( Visibility  userInfoPrivacy   , Visibility  postPrivacy   , Visibility  goalPrivacy   , Boolean  newComments   , Boolean  newLikes   , Boolean  friendshipRequest   , Boolean  acceptedFriendship   , Boolean  activityRequest   , Boolean  acceptedActivity   , Boolean  canceledActivity   , Boolean  nightTheme   ){
			this.userInfoPrivacy   = userInfoPrivacy  ;
			this.postPrivacy   = postPrivacy  ;
			this.goalPrivacy   = goalPrivacy  ;
			this.newComments   = newComments  ;
